...
public class Stack_authentication extends VariableGroup {
    ...
    public void setUse_existing_token(boolean newValue) {
    ...
    public void setCurrent_user_token(Object newValue) {
    ...
    public void setUse_existing_vault(boolean newValue) {
    ...
    public void setNew_vault_display_name(String newValue) {
    ...
    public void setVault_compartment_id(Object newValue) {
    ...
    public void setVault_id(Object newValue) {
    ...
    public void setKey_id(Object newValue) {
